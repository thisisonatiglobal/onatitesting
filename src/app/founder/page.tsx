  ...
  return (
    <section className="pb-16 pt-20 relative " >
      <div className="navbar flex justify-center md:justify-center p-4">
        <a href={"https://in.linkedin.com/in/rakhi-peethamber-a8786b60"} className="mr-4"><img src="/images/logo/linkdin.jpg" alt="LinkedIn" className="w-8 h-8" /></a>
        <a href={founder.facebook} className="mr-4"><img src="/images/logo/fb.jpg" alt="Facebook" className="w-8 h-8" /></a>
        <a href={"https://www.instagram.com/onati_global/reels/"} className="mr-4"><img src="/images/logo/insta.jpg" alt="Instagram" className="w-8 h-8" /></a>
        <a href={founder.twitter} className="mr-4"><img src="/images/logo/X.jpeg" alt="Twitter" className="w-8 h-8" /></a>
      </div>
